...
function jf_load_custom_wp_admin_script( ) {
  wp_register_script( 'admin_js', get_template_directory() . '/assets/js/admin.js', array( 'jquery' ), null, true );
...
function jf_load_custom_wp_admin_style() {
  wp_register_style( 'admin_css', get_template_directory() . '/assets/css/admin.css', false, '1.0.0' );
