...
function jf_load_custom_wp_admin_script( ) {
  wp_register_script( 'admin_js', get_template_directory_uri() . '/assets/dist/js/script-admin.js', array( 'jquery' ), null, true );
...
function jf_load_custom_wp_admin_style() {
  wp_register_style( 'admin_css', get_template_directory_uri() . '/assets/dist/css/style-admin.css', false, '1.0.0' );
...
function jf_add_editor_style() {
  ...
  add_editor_style( get_template_directory_uri() . '/assets/dist/css/style-editor.css' );
}
